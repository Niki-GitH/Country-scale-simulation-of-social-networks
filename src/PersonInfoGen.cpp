...
CPersonInfoGen::CPersonInfoGen(std::string data_folder_path)
{
	ReadFirstNamesDBF(data_folder_path+"/FirstName-Female.txt");
	ReadFirstNamesDBM(data_folder_path+"/FirstName-Male.txt");
	ReadLastNamesDB(data_folder_path+"/surnames.txt");
	m_vLetters = {"a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n",
...
CPersonInfoGen::~CPersonInfoGen()
{
	...
	std::vector<std::string>(m_vFirstNames_M).swap(m_vFirstNames_M);
	m_vFirstNames_F.clear();
	std::vector<std::string>(m_vFirstNames_F).swap(m_vFirstNames_F);
	m_vLastName.clear();
	std::vector<std::string>(m_vLastName).swap(m_vLastName);
	m_vLetters.clear();
	std::vector<std::string>(m_vLetters).swap(m_vLetters);
}
